...
public class BbsDAO {
	...
	public boolean create(BbsDTO dto) {
		...
		sql.append(" ?,?,?,?,sysdate, ");
		sql.append(" (select nvl(max(grpno),0) +1 as bbsno from bbs)) ");	//grpno
	...
	public boolean createReply(BbsDTO dto) {
		...
		try {
			...
			pstmt.setString(3, dto.getContent());
			pstmt.setString(4, dto.getPasswd());
			pstmt.setInt(5, dto.getGrpno());	//★그냥
			pstmt.setInt(6, dto.getIndent()+1);	//★부모+1
			pstmt.setInt(7, dto.getAnsnum()+1);	//★부모+1
